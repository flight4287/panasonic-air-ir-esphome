...
bool APIConnection::send_climate_info(climate::Climate *climate) {
  ...
  for (auto swing_mode : {climate::CLIMATE_SWING_OFF, climate::CLIMATE_SWING_BOTH, climate::CLIMATE_SWING_VERTICAL,
                          climate::CLIMATE_SWING_HORIZONTAL, climate::CLIMATE_SWING_HIGHEST, climate::CLIMATE_SWING_HIGH,
                          climate::CLIMATE_SWING_MIDDLE, climate::CLIMATE_SWING_LOW, climate::CLIMATE_SWING_LOWEST,
                          climate::CLIMATE_SWING_AUTO}) {

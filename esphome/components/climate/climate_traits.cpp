...
void ClimateTraits::set_supports_swing_mode_highest(bool supports_swing_mode_highest) {
  this->supports_swing_mode_highest_ = supports_swing_mode_highest;
}
void ClimateTraits::set_supports_swing_mode_high(bool supports_swing_mode_high) {
  this->supports_swing_mode_high_ = supports_swing_mode_high;
}
void ClimateTraits::set_supports_swing_mode_middle(bool supports_swing_mode_middle) {
  this->supports_swing_mode_middle_ = supports_swing_mode_middle;
}
void ClimateTraits::set_supports_swing_mode_low(bool supports_swing_mode_low) {
  this->supports_swing_mode_low_ = supports_swing_mode_low;
}
void ClimateTraits::set_supports_swing_mode_lowest(bool supports_swing_mode_lowest) {
  this->supports_swing_mode_lowest_ = supports_swing_mode_lowest;
}
void ClimateTraits::set_supports_swing_mode_auto(bool supports_swing_mode_auto) {
  this->supports_swing_mode_auto_ = supports_swing_mode_auto;
}
...
bool ClimateTraits::supports_swing_mode(ClimateSwingMode swing_mode) const {
  switch (swing_mode) {
    ...
    case climate::CLIMATE_SWING_HIGHEST:
      return this->supports_swing_mode_highest_;
    case climate::CLIMATE_SWING_HIGH:
      return this->supports_swing_mode_high_;
    case climate::CLIMATE_SWING_MIDDLE:
      return this->supports_swing_mode_middle_;
    case climate::CLIMATE_SWING_LOW:
      return this->supports_swing_mode_low_;
    case climate::CLIMATE_SWING_LOWEST:
      return this->supports_swing_mode_lowest_;
    case climate::CLIMATE_SWING_AUTO:
      return this->supports_swing_mode_auto_;
    default:
      return false;
  }
}
bool ClimateTraits::get_supports_swing_modes() const {
  return this->supports_swing_mode_off_ || this->supports_swing_mode_both_ || supports_swing_mode_vertical_ ||
         this->supports_swing_mode_horizontal_ || this->supports_swing_mode_highest_ || this->supports_swing_mode_high_ ||
         this->supports_swing_mode_middle_ || this->supports_swing_mode_low_ || this->supports_swing_mode_lowest_ ||
         this->supports_swing_mode_auto_;
}
}  // namespace climate
}  // namespace esphome

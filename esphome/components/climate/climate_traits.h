...
class ClimateTraits {
 public:
  ...
  void set_supports_swing_mode_highest(bool supports_swing_mode_highest);
  void set_supports_swing_mode_high(bool supports_swing_mode_high);
  void set_supports_swing_mode_middle(bool supports_swing_mode_middle);
  void set_supports_swing_mode_low(bool supports_swing_mode_low);
  void set_supports_swing_mode_lowest(bool supports_swing_mode_lowest);
  void set_supports_swing_mode_auto(bool supports_swing_mode_auto);
 ...
 protected:
  ...
  bool supports_swing_mode_highest_{false};
  bool supports_swing_mode_high_{false};
  bool supports_swing_mode_middle_{false};
  bool supports_swing_mode_low_{false};
  bool supports_swing_mode_lowest_{false};
  bool supports_swing_mode_auto_{false};

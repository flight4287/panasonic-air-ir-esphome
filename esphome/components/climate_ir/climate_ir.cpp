  ...
  for (auto swing_mode : this->swing_modes_) {
    switch (swing_mode) {
      ...
      case climate::CLIMATE_SWING_HIGHEST:
        traits.set_supports_swing_mode_highest(true);
        break;
      case climate::CLIMATE_SWING_HIGH:
        traits.set_supports_swing_mode_high(true);
        break;
      case climate::CLIMATE_SWING_MIDDLE:
        traits.set_supports_swing_mode_middle(true);
        break;
      case climate::CLIMATE_SWING_LOW:
        traits.set_supports_swing_mode_low(true);
        break;
      case climate::CLIMATE_SWING_LOWEST:
        traits.set_supports_swing_mode_lowest(true);
        break;
      case climate::CLIMATE_SWING_AUTO:
        traits.set_supports_swing_mode_auto(true);
        break;
    }
  }
  return traits;
